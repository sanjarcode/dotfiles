...
(function() {
    ...
    const allFeatures = {
        toggleUdemySideBar() {
            const toggleUdemySideBarAction = () => {
                try {
                    const theatreModeButton = document.querySelector('*[data-purpose="theatre-mode-toggle-button"]');
        ...
        toggleStudyPauseMode() {
                ...
                function toggleVideo(value = null) {
                    ...
                    switch (value) {
                        ...
                        case "pause":
                            ...
                            break;
                        default:
                            mainVideoElement.paused ? mainVideoElement.play() : mainVideoElement.pause();
                            break
                    }
            ...
            const currentValue = JSON.parse(localStorage.getItem(TUTORIAL_MODE_TOGGLE_KEY) || "false");
    ...
    "complete" === document.readyState ? onVideoLoaded() : window.addEventListener("load", onVideoLoaded);
})();